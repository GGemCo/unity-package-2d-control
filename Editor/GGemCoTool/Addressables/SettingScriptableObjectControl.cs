...
namespace GGemCo2DControlEditor
{
    ...
    /// </summary>
    public class SettingScriptableObjectControl : DefaultAddressable
    {
        ...
        private void Setup()
        {
            ...
            foreach (var addressableAssetInfo in ConfigAddressableSettingControl.NeedLoadInLoadingScene)
            {
